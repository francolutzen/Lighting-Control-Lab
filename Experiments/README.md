...
Most experiments follow a simple process:

1. Define an idea or visual objective.
2. Program scenes, banks or chases.
3. Test the result using real fixtures.
4. Document photos and videos.
5. Record observations and conclusions.
6. Refine the programming if necessary.
